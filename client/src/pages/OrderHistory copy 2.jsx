...
const OrderHistory = () => {
    ...
    useEffect(() => {
        const fetchOrderHistory = async () => {
            try {
                setLoading(true);
                const response = await getOrderHistory(user.id, { page, limit, sort, order, search, startDate, endDate });
                // Assicurati che la risposta contenga sempre un array di ordini
        ...
        fetchOrderHistory();
    }, [page, limit, sort, order, search, startDate, endDate]);
